...
" ale settings
let b:ale_linters = {'python': ['pep8', 'flake8', 'isort']}
" ncm2 settings
...
au FileType python map <silent> <leader>b ofrom  import set_trace; set_trace()<esc>
...
" Impsort option
hi pythonImportedObject ctermfg=250
hi pythonImportedFuncDef ctermfg=250
hi pythonImportedClassDef ctermfg=250
